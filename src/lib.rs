...
impl<DELAY, PIN> Sent<DELAY, PIN> {
	pub fn new(delay: DELAY, pin: PIN,t_frame: u32, t_tick: u32,t_sync: u32,t_offset: u32,nb_nibbles: u32) -> Self {
		Self {delay, pin, t_frame, t_tick, t_sync, t_offset, nb_nibbles}
	}
